...
public class prac{
    ...
    public static void main(String[] args) {
       ...
       prac e = new prac();
        ...
        switch (opcion){
            case 0 -> JOptionPane.showMessageDialog(null, "EL PROGRAMA HA TERMINADO", "Fin de programa",JOptionPane.PLAIN_MESSAGE);
            case 1 -> e.LlegadaClientesACola1();
            case 2 -> e.BorraCola1EInsertorTemporal();
            case 3 -> e.BorreDePila();
            case 4 -> e.BorreDeCOLA2eImprimir();
            case 5 -> e.ImprimirPILA();
            case 6 -> e.ImprimirTEMPORAL();
            case 7 -> e.ImprimirCOLA1();
            case 8 -> e.ImprimirCOLA2();
            case 9 -> e.tamaños();
            case 10 -> e.primerCOLA1();
            case 11 -> e.primerCOLA2();
            case 12 -> e.ultimoPILA();
            case 13 -> e.ultimoCOLA2();
